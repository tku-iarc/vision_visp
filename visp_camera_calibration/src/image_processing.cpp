    ...
    is_initialized(false)
{
  ...
  assert(selected_points_x_list.as_double_array().size() == selected_points_y_list.as_double_array().size() && selected_points_x_list.as_double_array().size()==selected_points_z_list.as_double_array().size());
